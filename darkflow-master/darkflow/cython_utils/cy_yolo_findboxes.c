 ...
 */
      ...
      __pyx_t_24 = 1;
      *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_22 * __pyx_v_coords.strides[0]) ) + __pyx_t_23 * __pyx_v_coords.strides[1]) )) + __pyx_t_24)) )) = (((*((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_18 * __pyx_v_coords.strides[0]) ) + __pyx_t_17 * __pyx_v_coords.strides[1]) )) + __pyx_t_16)) ))) + (__pyx_v_grid / __pyx_v_S)) / __pyx_v_S);
 ...
 */
      ...
      __pyx_t_27 = 2;
      *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_25 * __pyx_v_coords.strides[0]) ) + __pyx_t_26 * __pyx_v_coords.strides[1]) )) + __pyx_t_27)) )) = powf((*((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_16 * __pyx_v_coords.strides[0]) ) + __pyx_t_17 * __pyx_v_coords.strides[1]) )) + __pyx_t_18)) ))), __pyx_v_sqrt);
 ...
 */
      ...
      __pyx_t_30 = 3;
      *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_28 * __pyx_v_coords.strides[0]) ) + __pyx_t_29 * __pyx_v_coords.strides[1]) )) + __pyx_t_30)) )) = powf((*((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_coords.data + __pyx_t_18 * __pyx_v_coords.strides[0]) ) + __pyx_t_17 * __pyx_v_coords.strides[1]) )) + __pyx_t_16)) ))), __pyx_v_sqrt);
 ...
 */
        ...
        *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_probs.data + __pyx_t_35 * __pyx_v_probs.strides[0]) )) + __pyx_t_36)) )) = ((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_probs.data + __pyx_t_16 * __pyx_v_probs.strides[0]) )) + __pyx_t_17)) ))) * (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_confs.data + __pyx_t_18 * __pyx_v_confs.strides[0]) )) + __pyx_t_34)) ))));
 ...
 */
        ...
        __pyx_t_37 = (((*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_probs.data + __pyx_t_34 * __pyx_v_probs.strides[0]) )) + __pyx_t_18)) ))) > __pyx_v_threshold) != 0);
        if (__pyx_t_37) {
 ...
 */
          ...
          __pyx_t_38 = __pyx_v_class_loop;
          *((float *) ( /* dim=2 */ ((char *) (((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_final_probs.data + __pyx_t_17 * __pyx_v_final_probs.strides[0]) ) + __pyx_t_16 * __pyx_v_final_probs.strides[1]) )) + __pyx_t_38)) )) = (*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_probs.data + __pyx_t_18 * __pyx_v_probs.strides[0]) )) + __pyx_t_34)) )));
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  __pyx_t_39 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_float(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_39.memview)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __pyx_f_8darkflow_12cython_utils_3nms_NMS(__pyx_t_10, __pyx_t_39); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
